...
namespace NerdStore.Vendas.Domain.VoucherAgregacao
{
  ...
  {
    // Definindo as mensagens de erros. Uma para cada situação.
    ...
    protected static bool DataVencimentoSuperiorAtual(DateTime dataVencimento) => dataVencimento >= DateTime.Now;
  }
}
