...
namespace NerdStore.Vendas.Application.Tests.Pedidos
{
  public class AdicionarItemPedidoCommandTests
  {
    ...
    public void AdicionarItemPedidoCommand_CommandoEstaValido_DevePassarNaValidacao()
    {
      ...
      // Act
      var result = pedidoCommand.EhValido(); // O Command precisa se auto validar.
    ...
    {
      // Arrange
      var pedidoCommand = new AdicionarItemPedidoCommand(Guid.NewGuid(), Guid.NewGuid(), "Produto Teste", PedidoConstantes.MAX_UNIDADES_ITEM + 1, 100);
